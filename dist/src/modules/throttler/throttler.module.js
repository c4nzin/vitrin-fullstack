...
const throttler_config_service_1 = require("./throttler-config.service");
...
exports.ThrottlerModule = ThrottlerModule = __decorate([
    (0, common_1.Module)({
        imports: [throttler_1.ThrottlerModule.forRootAsync({ useClass: throttler_config_service_1.ThrottlerConfigService })],
    })
], ThrottlerModule);
