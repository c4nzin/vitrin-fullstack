<template>
  <section class="h-screen">
    <div class="flex mb-2 justify-center h-full items-center bg-white">
      <div
        class="w-5/6 max-w-[800px] h-screen mt-0 bg-white border-4 rounded drop-shadow-2xl shadow-black"
      >
        ...
        <div class="flex w-full h-64 relative rounded">
          ...
          >
            <img
              src="https://archive.org/download/3d_20190714/3d.jpg"
        ...
        <div class="flex justify-evenly items-center mt-10">
          ...
          <div class="text-center">
            <div class="text-2xl font-semibold">{{ statistics.series }}</div>
